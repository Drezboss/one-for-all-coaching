        ...
        <div className="flex justify-between items-center py-4">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <div className="flex items-center">
              ...
              <Sparkles className="h-6 w-6 text-secondary-500 -ml-2" />
            </div>
            <div className="flex flex-col">
              <span className="text-xl font-bold text-gray-900">GreenClean</span>
              <span className="text-xs text-gray-600">Garden & Home Services</span>
            </div>
          </Link>
